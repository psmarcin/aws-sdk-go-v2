...
func (m *awsAwsjson10_deserializeOpEmptyInputAndEmptyOutput) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if err := decoder.Decode(&shape); err != nil && err != io.EOF {
		...
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body40, %w", err),
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body41, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
...
func awsAwsjson10_deserializeOpErrorEmptyInputAndEmptyOutput(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body42, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func awsAwsjson10_deserializeOpErrorEndpointOperation(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body43, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func awsAwsjson10_deserializeOpErrorEndpointWithHostLabelOperation(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body44, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func (m *awsAwsjson10_deserializeOpGreetingWithErrors) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if err := decoder.Decode(&shape); err != nil && err != io.EOF {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body45, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body46, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
...
func awsAwsjson10_deserializeOpErrorGreetingWithErrors(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body47, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func awsAwsjson10_deserializeOpErrorHostWithPathOperation(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body48, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func (m *awsAwsjson10_deserializeOpJsonUnions) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if err := decoder.Decode(&shape); err != nil && err != io.EOF {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body49, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body50, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
...
func awsAwsjson10_deserializeOpErrorJsonUnions(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body51, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func awsAwsjson10_deserializeOpErrorNoInputAndNoOutput(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body52, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func (m *awsAwsjson10_deserializeOpNoInputAndOutput) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if err := decoder.Decode(&shape); err != nil && err != io.EOF {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body53, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body54, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
...
func awsAwsjson10_deserializeOpErrorNoInputAndOutput(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body55, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func (m *awsAwsjson10_deserializeOpSimpleScalarProperties) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	...
	if err := decoder.Decode(&shape); err != nil && err != io.EOF {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body56, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body57, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return out, metadata, err
	}
...
func awsAwsjson10_deserializeOpErrorSimpleScalarProperties(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body58, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func awsAwsjson10_deserializeErrorComplexError(response *smithyhttp.Response, errorBody *bytes.Reader) error {
	...
	if err := decoder.Decode(&shape); err != nil && err != io.EOF {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body59, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body60, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func awsAwsjson10_deserializeErrorFooError(response *smithyhttp.Response, errorBody *bytes.Reader) error {
	...
	if err := decoder.Decode(&shape); err != nil && err != io.EOF {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body61, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body62, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
...
func awsAwsjson10_deserializeErrorInvalidGreeting(response *smithyhttp.Response, errorBody *bytes.Reader) error {
	...
	if err := decoder.Decode(&shape); err != nil && err != io.EOF {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body63, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
	...
	if err != nil {
		...
		io.Copy(&snapshot, ringBuffer)
		err = &smithy.DeserializationError{
			Err:      fmt.Errorf("failed to decode response body64, %w", err),
			Snapshot: snapshot.Bytes(),
		}
		return err
	}
